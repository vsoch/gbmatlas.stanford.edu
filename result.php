...
<body>
    ...
    <div class="extra_custom_styling" style="margin-top: 22px;">
<section id="services">
<div class="container">
        <div class="row">
	  <div class="col-sm-6">
	...
	if (isset($_GET['gene'])){
		...
		// Shiny Plot  
		printf( '<iframe src="http://gbmatlas.stanford.edu:3939/gbmatlas/?gene=%s" width="1200px" height="800px" display="none", frameBorder="0"></iframe>', $geneID);
	}
